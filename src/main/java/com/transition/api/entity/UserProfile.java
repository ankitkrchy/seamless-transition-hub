...
public class UserProfile {
	...
	public String toString() {
		return "UserProfile [photoUrl=" + photoUrl + ", fullName=" + fullName + ", email=" + email + ", contact="
				...
				+ ", organisationName=" + organisationName + ", position=" + position + ", workexperience="
				+ workexperience + ", keySkills=" + keySkills + ", description=" + description + ", linkedinLink="
				+ linkedinLink + ", gitLink=" + gitLink + "]";
	}
